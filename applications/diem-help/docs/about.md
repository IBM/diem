...
<div style="font-size:16px;font-weight: bold;line-height: 2rem;"><blockquote>Python, Spark, REST, Scala, Pipelines, Scheduling, API, Custom Jobs, SQL Statements, Openshift, Cloud Native, Machine Learning, Sendgrid, Kubernetes, Slack, Cloud Object Storage, JDBC, Box</blockquote></div>
